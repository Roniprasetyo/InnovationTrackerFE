          ...
          <div className="card-body p-4">
            {isLoading ? (
              ...
              <div className="row">
                ...
                <hr className="mb-3" />
                <div className="col-lg-3 border rounded-4">
                  <Label
                    title="Project Title"
                ...
                <div className="col-lg-3 border rounded-4">
                  <Label title="Category" data={formDataRef.current.Category} />
                </div>
                <div className="col-lg-3 border rounded-4">
                  <Label
                ...
                <div className="col-lg-3 border rounded-4">
                  <Label title="Period" data={formDataRef.current["Period"]} />
                </div>
                <div className="col-lg-12 border rounded-4 mt-3 mb-3 py-1">
                  <Label
                ...
                <div className="col-lg-12 border rounded-4 mb-3 py-1">
                  <Label
                  ...
                  {formDataRef.current["ProblemFile"] && (
                    <a
                      href={FILE_LINK + formDataRef.current["ProblemFile"]}
                      className="text-decoration-none"
                      target="_blank"
                    >
                      <sub>[Download File]</sub>
                ...
                <div className="col-lg-12 border rounded-4 mb-3">
                  <Label
                    title="Project Scope"
                ...
                <div className="col-lg-12 border rounded-4 mb-3">
                  <Label
                    ...
                    data={separator(formDataRef.current["Project Benefit"])}
                  />
                </div>
                <div className="col-lg-6 border rounded-4 p-3">
                  <label className="form-label fw-bold">Tangible Benefit</label>
                ...
                <div className="col-lg-6 border rounded-4 p-3">
                  ...
                  <div className="d-flex align-items-center">
                    <Label title="Moral" data={formDataRef.current["Moral"]} />
                  </div>
                </div>
                <sub>Submitted By</sub>
              </div>
            )}
          </div>
        </div>
